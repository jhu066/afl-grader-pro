...
export ROOT_CHECK=/home/jie/projects/covrare-exp-15/filter_jobs
export ROOT_WRITE=/home/jie/projects/covrare-exp-15/findings_dir
export COVERG_DIR=/home/jie/projects/covrare-exp-15/cov-plot
...
# for who
AFL_SKIP_CPUFREQ=1 ./afl-fuzz -Q -m 1024 -t 90 -k $COVERG_DIR -S $FILTER_NAME -s $ROOT_CHECK -o $ROOT_WRITE -- $WHO_BIN @@
